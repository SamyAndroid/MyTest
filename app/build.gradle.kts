...
android {
    namespace = "com.rdissi.mytest"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.rdissi.mytest"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    val archCoreTestingVersionAndroidX = "2.2.0"
    val testCoroutines = "1.7.3"

    testImplementation("junit:junit:4.13.2")
    testImplementation("org.junit.jupiter:junit-jupiter:5.8.1")
    testImplementation("org.mockito:mockito-inline:$mockitoVersion")
    testImplementation("com.nhaarman:mockito-kotlin:$mockitoKotlinVersion")
    testImplementation("androidx.arch.core:core-testing:$archCoreTestingVersionAndroidX")
